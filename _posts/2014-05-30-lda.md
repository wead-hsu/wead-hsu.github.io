...
LDA(latent dilichlet allocation) is a method to assign the topic (distribution) of a given document. However, note that this model is tied to text applications. The complementary applications can refer to original paper[1]. To have a simple overview of this algorithm,  refer to [2].
...
### 3. Why to use the variational inference to approximate posterior distribution?
